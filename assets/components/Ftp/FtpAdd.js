...
function FtpAdd() {
    ...
    return (
        <>
            <Button variant="primary" style={{marginLeft:"90%"}} onClick={ () =>setShow(true)}> Add FTP access</Button>

            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Add Access to FTP</Modal.Title>
                </Modal.Header>
                <Modal.Body>
